...
const Button = ({
  ...
  const variants = {
    primary: 'text-white shadow-md shadow-indigo-600/20 hover:from-indigo-700 hover:to-indigo-900 focus:ring-indigo-500 bg-gradient-to-b from-[#0f172a] via-[#111827] to-[#172554]',
